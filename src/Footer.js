  ...
  return(
    ...
    <footer className='contact-footer' style={{ backgroundColor: '#eaf9ee', height: '15vh' }}>
       ...
       <p className='text-center' style={{paddingTop: '10px'}}>
         ...
         <a href='https://www.facebook.com/116416677735623/posts/pfbid0NRBP52uncrtwPFBiGFeTAPT8eGJKmmzSpX2TW8kyBd1768ynaW6Pe6J1ELUueUvUl/?sfnsn=mo&extid=a&mibextid=hOoF3G'><img src={facebook} alt='' width={40} style={{paddingRight: '20px'}}/></a>
        <a href='https://www.linkedin.com/in/worthwink-investment-limited-0b606a252/'><img src={linkedin} alt='' width={30} /></a> 
        </span>
         </p>
